...
const highestReductionLink = 'https://www.dealabs.com/groupe/lego';
// 2. Log the variable
console.log('The site with the highest reduction is', highestReductionLink);
...
const communityNames = deals.map(d => d.communityName);
// 2. Log the variable
